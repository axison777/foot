    ...
    template: ` <!-- <app-floating-configurator /> -->
        <div class="flex items-center justify-center min-h-screen overflow-hidden">
          ...
          <!--       <svg width="54" height="40" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-8 w-32 shrink-0">
                ...
                <div style="border-radius: 26px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 23px">
                        <span class="text-primary font-bold text-3xl">404</span>
                        <h1 class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-2">Page non trouvée</h1>
                        <div class="text-surface-600 dark:text-surface-500 mb-8">Cette page n'existe pas</div>
<!--                         <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <p-button label="Aller à la page d'accueil" routerLink="/" />
                    </div>
                </div>
            </div>
        </div>`
